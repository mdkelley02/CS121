...
public class Orbit extends JPanel
{
	...
	private final ImageIcon DOOMER_ICON = new ImageIcon("Doomer.jpg");
	...
	public void paintComponent(Graphics g)
	{
		...
		Random r = new Random();
//		Color randomColor = new Color(r.nextInt(256), r.nextInt(256), r.nextInt(256), r.nextInt(256));
//		g.setColor(randomColor);
//		g.fillOval(objectX-objectRadius, objectY-objectRadius, objectRadius*2, objectRadius*2);
		g.drawImage(DOOMER_ICON.getImage(), objectX-objectRadius, objectY-objectRadius, objectRadius*2, objectRadius*2, null);
